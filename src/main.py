...
def buyPizza(price, balance):
  ...
  # It also creates a dictionary to store information about the pizza
    ...
    enough = not_enough_balance_to_do_stuff(new_balance, price)  # Changed function name to match previous version
    if enough:
        return pizza
    else:
        return None