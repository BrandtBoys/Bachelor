...
def sub(a,b):
  ...
  # The subtraction is done by simply returning the difference between 'a' and 'b'.
    print("Test print")
    return a-b

def enough_balance_to_do_stuff(balance, amount):
  # This function checks if there's enough balance in the account to do something.
  # It does this by subtracting the amount from the balance and checking if the result is greater than 0.
    return sub(balance, amount) > 0 

def not_enough_balance_to_do_stuff(balance, amount):
  # This function checks if there's not enough balance in the account to do something.
...
def buyPizza(price, balance):
  ...
  # It first deducts the price from the balance, then creates a dictionary representing the pizza with its details.
