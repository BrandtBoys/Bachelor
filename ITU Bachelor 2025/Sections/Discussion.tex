...
"\textit{\subquestionII}"
In attempt to answer \textbf{Q2} we used the `stsb-roberta-base’ model from Sentence transformer to calculate the semantic similarities between function-level documentation created by the developers of Flask and the generated comments made by DocTide. To understand what these score actually inferred we picked 10\% of the
