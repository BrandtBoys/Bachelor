...
\newcommand{\researchQuestion}{\textit{How can a autonomous LLM-based agent be integrated into a Github repository through Github Actions, to automate the task of making method level documentation, \textcolor{red}{while maintaining the human in the loop?}}}
